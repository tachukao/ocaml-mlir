...
let populate_loop_body ctx loop_body loc func_body =
  ...
  Block.append_operation loop_body load_lhs;
  ...
  Block.append_operation loop_body load_rhs;
  (* addf *)
  ...
  Block.append_operation loop_body add;
  (* store state *)
...
let make_and_dump_add ctx loc =
  ...
  Region.append_block func_region func_body;
  ...
  OperationState.add_regions func_state [ func_region ];
  let func = Operation.create func_state in
  Block.insert_operation module_body 0 func;
  ...
  Block.append_operation func_body const_zero;
  let func_arg0 = Block.argument func_body 0 in
  ...
  Block.append_operation func_body dim;
  let loop_body_region = Region.create () in
  let loop_body = Block.create [ index_type ] in
  Region.append_block loop_body_region loop_body;
  ...
  Block.append_operation func_body const_one;
  ...
  OperationState.add_regions loop_state [ loop_body_region ];
  let loop = Operation.create loop_state in
  Block.append_operation func_body loop;
  ...
  Block.append_operation func_body ret;
